...
За допомогою інструментів проксування (наприклад, Charles Proxy або Fiddler) учасники мають перехопити HTTP/HTTPS-запити. Метою буде перевірити, які саме дані передаються між клієнтом і сервером і як реагує додаток на різні статус коди.
