...
Надати учасникам доступ до Swagger-документації для API сервісу, що обробляє запити від мобільного застосунку. Мета — розробити тестові кейси для основних REST API ендпоінтів, включаючи позитивні та негативні сценарії.
